...
$query = 'SELECT * FROM users_panel.users WHERE id=?';
...
if (
    ...
    if (isset($_FILES['image']) and $_FILES['image']['name'] !== '') {
        ...
        if ($user !== false and $image_upload !== false) {
            ...
            $query = 'UPDATE users_panel.users SET image = ? , first_name = ? , last_name=? ,email = ? , update_at = NOW() WHERE id=?';
            $statment = $pdo->prepare($query);
        ...
        if ($user !== false) {
            $query = 'UPDATE users_panel.users SET first_name = ? , last_name=? ,email = ? , update_at = NOW() WHERE id=?';
            $statment = $pdo->prepare($query);
...
<body>
    <style>
        ...
        img {
            border-radius: 100px;
            box-shadow: 0 0 13px 2px #686868;
            margin-top: 29px;
        }
                        ...
                        <div class="account-settings">
                            <div class="user-profile">
                                <div class="user-avatar">
                                    <img src="<?= asset($user->image) ?>" alt="Maxwell Admin" width="200px"
                                        height="200px">
                                </div>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        <div class="row gutters">
                            ...
                            <form action="<?= url('panel/edit.php?user_id=' . $user->id) ?>" method="post"
                                enctype="multipart/form-data">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">

                                        <label for="website">first name</label>
                                        <input type="text" name="first_name" class="form-control" id="website"
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="last_name" class="form-control" id="phone"
