...
if (
  ...
  $query = 'SELECT * FROM users_panel.users WHERE  email = ?';
    ...
    if ($_POST['password'] === $_POST['confirm_password']) {
      ...
      if (isset($_FILES['profile_image']) && $_FILES['profile_image']['name'] !== '') {
        ...
        if ($user === false && $image_upload !== false) {
          ...
          $query = 'INSERT INTO users_panel.users SET first_name = ? , last_name = ? , password = ? , email=? ,type_user =? ,image = ?, created_at = NOW();';
          $statement = $pdo->prepare($query);
      ...
      $error = 'رمز عبور تطابق ندارد مجددن تلاش کنید';
    }

  } else { {
      $error = 'رمزعبور باید بیشتر از 5 کاراکتر باشد';
    }
  }
          ...
          <div class="login-screen">
            <div class="login-box">
              ...
              <div class="row gutters">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                  <div class="form-group">
                    <input type="password" class="form-control" name="confirm_password" placeholder="تایید رمز عبور"
                      required>
                  </div>
                </div>
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
